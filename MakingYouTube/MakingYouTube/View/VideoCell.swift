...
class VideoCell: BaseCell {
    ...
    let userProfileImageView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = UIImage(named: "taylor_swift_profile_pic")
    ...
    let subtitleTextView: UITextView = {
        ...
        textView.text = "TaylorSwiftVEVO • 2,299,974,146 views • 3 years ago"
    ...
    override func setupViews() {
        ...
        // height constraint
        titleLabelHeightConstraint = NSLayoutConstraint(item: titleLabel, attribute: .height, relatedBy: .greaterThanOrEqual, toItem: self, attribute: .height, multiplier: 0, constant: 44)
